...
public class TestData {
    ...
    public static List<Notification> getNotification() {
        ...
        data.add(new Notification("Boost your earnings by inviting friends. \nTheres no limit to how much you can earn!", "04/04/16  3.05am"));
        data.add(new Notification("Wallmart receit pending.", "04/04/16  3.05am"));
        data.add(new Notification("Remember, you have 3 rebated on your shopping list!", "04/04/16   3.05am"));
        return data;
    }
