...
//import com.quickveggies.quickveggies.ui.fragment.AddressListFragment;
//import com.quickveggies.quickveggies.ui.fragment.NoAddressFoundFragment;
...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) R.layout.actvity_order);
    ...
    public void updateAddressFragment() {
        ...
        if (AddressRepo.getInstance().getCount() > 0) {
            FragmentUtils.changeFragment((FragmentActivity) this, (int) R.id.content, AddressListFragment.newInstance(), false);
        } else {
            FragmentUtils.changeFragment((FragmentActivity) this, (int) R.id.content, NoAddressFoundFragment.newInstance(), false);
        }
    }
